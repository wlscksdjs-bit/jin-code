...
export function SalesForm({ customers, projects, managers }: { 
  customers: Customer[]
  projects: Project[]
  managers: User[]
}) {
    ...
    <form action={handleSubmit} className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input id="title" name="title" placeholder="입찰/계약 제목" required />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="bidNumber" name="bidNumber" placeholder="입찰번호" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="bidAmount">입찰금액</Label>
          <Input id="bidAmount" name="bidAmount" type="number" placeholder="0" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="winProbability">수주 확률 (%)</Label>
          <Input id="winProbability" name="winProbability" type="number" min="0" max="100" placeholder="0" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="customerBudget">고객사 예산</Label>
          <Input id="customerBudget" name="customerBudget" type="number" placeholder="0" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="bidOpenDate" name="bidOpenDate" type="date" />
        </div>
