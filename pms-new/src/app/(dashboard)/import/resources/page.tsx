...
export default function ImportResourcesPage() {
  ...
  const downloadTemplate = async () => {
    ...
    a.href = url
    a.download = 'resources-template.xlsx'
    a.click()
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">인력 일괄 등록</h1>
        </div>
        <Link href="/resources">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Excel 파일로 인력 일괄 등록</CardTitle>
        </CardHeader>
